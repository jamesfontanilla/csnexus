...
A **ratio** is a way of comparing two or more quantities by showing how many times one value contains or is contained within another. Ratios are everywhere in daily life — from mixing ingredients in a recipe (2 cups flour to 1 cup sugar) to understanding government budget allocations (₱3 for education for every ₱1 for infrastructure). In the Philippine Civil Service Examination, ratio problems appear consistently because they test a candidate's ability to interpret relationships between quantities — a skill essential for any public servant who handles reports, budgets, inventories, or statistical data.

This subtopic covers six critical areas:
- **Meaning of Ratio** — what ratios represent and how they differ from simple numbers
- **Comparing Quantities** — using ratios to express relationships between amounts
- **Ratio Notation** — the three standard ways to write a ratio
- **Reducing Ratios to Lowest Terms** — simplifying ratios using common factors
- **Common Factors** — identifying shared divisors and the Greatest Common Factor (GCF)
- **Equivalent Ratios** — recognizing different expressions of the same relationship

Understanding ratios is the gateway to proportion, percentage, and average problems. Without a solid grasp of ratio fundamentals, examinees struggle with more advanced topics that build upon this foundation.

### Why Ratios Are Tested in the CSE

The Civil Service Exam tests ratios because:
- Government employees interpret budget ratios daily — comparing allocations across departments
- Public servants analyze population data using ratios (e.g., teacher-to-student ratios in DepEd reports)
- Administrative officers compute supply ratios for procurement planning
- HR personnel calculate employee-to-supervisor ratios for organizational restructuring
- Statistical reports submitted to oversight agencies express relationships as ratios
- Ratio reasoning is foundational to proportion, percentage, and rate problems that dominate the Numerical Ability subtest
- Map reading, engineering scales, and infrastructure planning all rely on ratio interpretation

### Common Mistakes Examinees Make

1. **Reversing the order** — writing "boys to girls" as girls:boys
2. **Simplifying only one term** — dividing the first number by a factor but forgetting the second
3. **Confusing part-to-part with part-to-whole** — writing 3:5 when the question asks for the ratio of 3 to the total of 8
4. **Using inconsistent units** — comparing meters to centimeters without converting first
5. **Stopping before lowest terms** — writing 4:6 instead of simplifying to 2:3
6. **Adding or subtracting ratio terms** — treating 3:4 as if it means 3 + 4 = 7
7. **Misidentifying the GCF** — using a common factor that is not the greatest one
8. **Confusing ratios with fractions conceptually** — a ratio compares two quantities; a fraction represents a part of a whole

### Learning Objectives

After this lesson, you should be able to:
- Define what a ratio is and explain its purpose in comparing quantities
- Compare two or more quantities using ratio language and notation
- Write ratios in colon, fraction, and word notation correctly
- Simplify ratios to their lowest terms using the Greatest Common Factor
- Identify common factors and compute the GCF of two numbers efficiently
- Recognize and generate equivalent ratios through multiplication and division
- Solve CSE-style ratio problems accurately and efficiently under time pressure
